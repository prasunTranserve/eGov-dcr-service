...
//		document.add(para3);
		...
		//approved by commented as of now-
		Phrase approvedBySection = new Phrase();
		Chunk approvedBySectionLine1 = new Chunk("Approved By\n", fontPara1);
		Chunk approvedBySectionLine2 = new Chunk("hardcode approver name", fontPara1);
